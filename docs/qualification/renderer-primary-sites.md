...
สถานะปัจจุบัน: **Instagram/TikTok/Facebook ผ่าน; Messenger.com รอ manual qualification ของรุ่น 0.0.3** — automated fixtures ของทั้งสี่เว็บไซต์ผ่านแล้ว ส่วนผล manual เดิมอยู่ที่ `docs/qualification/results/renderer-manual-primary-sites-win10-20260830.md`
...
| Facebook Messages | Emoji เดี่ยว, Emoji ใน bubble, reaction และ Quick Emoji แบบ image | ผ่าน | ทดสอบด้วยบัญชีจริงแล้ว; ใช้ Noto และคงขนาด 16/32px รวมถึงขนาดฐาน 56px ที่ Facebook ใช้ย่อ/ขยาย Quick Emoji |
...
| Messenger.com | Emoji เดี่ยว, Emoji ใน bubble และ reaction แบบ image | รอทดสอบ | ใช้ pipeline เดียวกับ Facebook; ต้องมีหน้าแชทจริงเพื่อยืนยัน DOM ปัจจุบัน |
