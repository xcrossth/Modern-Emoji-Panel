...
- [x] Hover Preview ปรากฏทันทีเมื่อชี้ โดยใช้ PNG 512 ขนาดประมาณ 160 DIP และไม่แย่ง focus
...
- [x] preview หน่วง 150 ms เมื่อ pointer ออก, reuse การ์ดเดิมเมื่อย้าย tile และหายทันทีเมื่อกด Esc หรือเริ่ม insert
...
- WPF smoke ตรวจ Ctrl+F, accessible name, popup ไม่รับ focus, การเปิดทันที, close grace 150 ms, การ reuse popup, preview 160 DIP จาก PNG 512, F1 และการปิด preview
