...
ตารางนี้เก็บผลตามเวลาที่ทดสอบจริงและไม่แก้ผลย้อนหลังเพียงเพราะโค้ดรุ่นถัดมาเพิ่ม regression หรือแก้สาเหตุแล้ว สถานะ Release ปัจจุบันและคำอธิบายการแก้หลังรอบ manual อยู่ใน [`README.md`](./README.md) และรายงานผลที่ลิงก์จากแต่ละแถว
