...
เว็บไซต์หลักของรุ่น `0.0.5` คือ Instagram Web DM, TikTok Web Chat, Facebook Messages/Inbox และ Messenger.com Inbox ส่วนเว็บไซต์อื่นเปิดเพิ่มได้จาก Options
...
Release รุ่น `0.0.5` ผ่านชุดทดสอบอัตโนมัติและการทดสอบบัญชีจริงบน Instagram DM, TikTok Chat, Facebook Messages/Inbox และ Messenger.com Inbox แล้ว โดย Facebook ไม่ครอบคลุม post/comment รุ่นนี้รักษาโครง DOM ของรายการห้องแชทแบบ virtualized ของ TikTok และจำกัด Noto ใน sidebar ไม่ให้แย่งแสดงตัวเลข ช่องว่าง หรือข้อความ ASCII แพ็กเกจ Release มี `release-metadata.json` และ verification report สำหรับตรวจสถานะของไฟล์ที่ดาวน์โหลด
...
- Instagram, TikTok, Facebook และ Messenger เปิดเป็นค่าเริ่มต้นตั้งแต่รุ่น `0.0.3`
